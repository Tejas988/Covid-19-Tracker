...
export default class IndiaItem extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={listItemStyles.container}>
        <CardItem style={{backgroundColor: '#FAFAFA'}}>
          <Text style={listItemStyles.name} allowFontScaling={false}>{this.props.item.loc}</Text>
          <Text style={listItemStyles.items} allowFontScaling={false}>
            {this.props.item.confirmedCasesIndian +
              this.props.item.confirmedCasesForeign}
          </Text>
